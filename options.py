...
parser.add_argument('--de_type', nargs='+', default=['dehaze', 'derain', 'denoise_15', 'denoise_25', 'denoise_50'],
...
parser.add_argument("--wblogger",type=str,default="TextPromptIR",help = "Determine to log to wandb or not and the project name")
